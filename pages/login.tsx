...
export default function SignIn() {
  return (
    <div className="wrapper relative">
      ...
      <div //             --------------------------- Form------------------------
        className="Form flex justify-center items-center h-screen"
      >
        <div className=" bg-black opacity-80 w-96 h-96  text-neutral-50 flex flex-col pt-4 pl-4  ">
          <h1 className="text-neutral-50 bg-opacity-100 text-size text-3xl">
            Sign in
          </h1>
          <form className="flex flex-col">
            ...
            ></input>
            <button className=" mt-2 border-solid border-2 border-orange-600 bg-orange-600 ">
              Sign In
            </button>
          </form>
        </div>
      ...
      <div //  ----------------------------Footer----------------------
      >
        <footer className="bg-gray-950 bg-opacity-70">
